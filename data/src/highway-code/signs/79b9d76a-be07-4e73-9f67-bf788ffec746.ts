export default {
    ...
    links: {
        available_translations: [
            {
                api_path:
                    '/api/content/guidance/the-highway-code/signals-by-authorised-persons',
                api_url:
                    'https://www.gov.uk/api/content/guidance/the-highway-code/signals-by-authorised-persons',
                base_path:
