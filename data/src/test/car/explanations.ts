...
const explanations: IQuestionExplanation[] = [
    ...
    },
    {
        ...
        content:
            "Before you change lanes, you should think about how your action will affect other drivers.\r\nUse your mirrors to check what's behind you, as well as keeping an eye on what's ahead of you. Give a signal to let other road users know the direction you intend to move in. And, when it's safe, you can change lanes.",
    },
    {
        questionCode: 'VM2067_3',
        content:
            "As you approach a large or complex roundabout, you'll see a sign telling you the layout of the roundabout and route directions. Use this to choose the lane you need.\r\nIf there are multiple lanes, there'll often be route numbers marked on the road to help you select the right lane.\r\nGet into the lane you need in plenty of time. Don't straddle lanes and avoid changing lanes at the last moment.",
    },
    {
        questionCode: 'VM2070_1',
        content:
            "A long vehicle at a roundabout may need to use the left-hand lane, even if it's signalling to go right. This is because it needs extra room to travel around a roundabout. For the same reason, it may also straddle lanes.\r\nWatch out for a long vehicle's signals and allow it plenty of room on a roundabout.",
    },
    {
        questionCode: 'VM2070_2',
        content:
            "Roundabouts can be dangerous places for cyclists. To stay safe, they may keep to the outside of a roundabout. They may cycle in the left lane, even if they intend to turn right. \r\nWatch out for a cyclist's arm signals, as they'll tell you the direction they intend to take. Always give cyclists plenty of room.",
    },
    {
        questionCode: 'VM2070_3',
        content:
            "A double yellow line at the edge of the road means no waiting at any time. \r\nThis means that you can't wait or park. However, you may stop on double yellow lines to drop off or pick up people. You may also stop to load or unload, provided there are no loading restrictions.",
    },
    {
        questionCode: 'VM2071_1',
        content:
            "It can be difficult for a driver emerging from a junction to see other road users. A vehicle that's overtaking might be hidden from the emerging driver's view, especially if the vehicle being overtaken is large, such as a lorry or coach.\r\nWhen you overtake, choose your time and place carefully.",
    },
    {
        questionCode: 'VM2071_2',
        content:
            "You need to learn different driving techniques for towing a caravan. And, due to your vehicle's increased weight and length, you must plan your manoeuvres well in advance. \r\nThe speed limit for towing a caravan is lower than for a vehicle that's not towing. This allows for the extra time it takes to slow down and stop.",
    },
    {
        questionCode: 'VM2071_3',
        content:
            "Diagonal white stripes edged by broken lines are used in the centre of the road to separate traffic going in opposite directions. They're called hatched markings and are often used at junctions.\r\nYou should only enter a hatched area bordered by a broken white line, if it's necessary and safe to do so.",
    },
    {
        questionCode: 'AB2952',
        content:
    ...
    },
    {
        questionCode: 'AB2950',
        content:
            "To rejoin the carriageway from an emergency refuge area, you must use the emergency telephone and follow the operator's advice. A lane may have to be closed so that you can rejoin the carriageway safely.",
    },
    {
        questionCode: 'AB2951',
        content:
