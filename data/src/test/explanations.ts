import { IQuestionExplanation } from "@drivingo/models";
...
const explanations: IQuestionExplanation[] = [
	...
	{
		questionCode: 'BB1002',
		content: 'Ensure that you can see clearly through the windscreen of your vehicle. Stickers or hanging objects could obstruct your view or draw your attention away from the road.'
	},
	{
		questionCode: 'BB1005',
		content: 'If you feel sleepy, you should leave the motorway at a service area or at the next exit and stop in a safe place to rest. A supply of fresh air can help to keep you alert before you reach the exit, but it isn\'t a substitute for stopping and resting.'
	},
	{
		questionCode: 'BB1007',
		content: 'Your headlights and tail lights help others on the road to see you. It may be necessary to turn on your headlights during the day if visibility is reduced; for example, due to heavy rain. In these conditions, the light might fade before the street lights are timed to switch on. Be seen to be safe.'
	},
	{
		questionCode: 'BB1287',
		content: 'Except for emergencies, it’s illegal to use a hand-held mobile phone while you\'re driving. Even using a hands-free kit can severely distract your attention.'
	},
	{
		questionCode: 'BB1294',
		content: 'It\'s illegal to use a hand-held mobile phone while you\'re driving, except in a genuine emergency. Even using a hands-free kit can distract your attention. Park in a safe and convenient place before receiving or making a call or using text messaging. Then you\'ll also be free to take notes or refer to papers.'
	},
	{
		questionCode: 'BB1366',
		content: 'As you drive, look well ahead and all around so that you’re ready for any hazards that might develop. If you have to stop in an emergency, react as soon as you can while keeping control of the vehicle. Keep both hands on the steering wheel so you can control the vehicle\'s direction of travel.'
	},
	{
		questionCode: 'BB1390',
		content: 'Before moving off, you should use both the interior and exterior mirrors to check that the road is clear. Look around to check the blind spots and, if necessary, give a signal to warn other road users of your intentions. Also look well ahead as you\'ll have to steer out into the road to pass the parked car.'
	},
	{
		questionCode: 'BB1439',
		content: 'Allow the cyclist plenty of room in case they wobble or swerve around a pothole or raised drain. Look well ahead before you start to overtake, because you\'ll need to cross the hazard line. Look for entrances where vehicles could be waiting to pull out.'
	},
	{
		questionCode: 'BB1573',
		content: 'Windscreen pillars can obstruct your view, particularly at bends and junctions. Look out for other road users – especially cyclists, motorcyclists and pedestrians who can easily be overlooked.'
	},
	{
		questionCode: 'BB1595',
		content: 'If you want to turn your car around, try to find a place where you have good all-round vision. If this isn’t possible, and you’re unable to see clearly, then get someone to guide you.'
	},
	{
		questionCode: 'BB1626',
		content: 'Modern vehicles provide the driver with a good view of both the road ahead and behind using well-positioned mirrors. However, the mirrors can’t see every angle of the scene behind and to the sides of the vehicle. It’s essential that you know when and how to check the vehicle\'s blind spots, so that you’re aware of any hidden hazards.'
	},
	{
		questionCode: 'BB1629',
	...
	{
		questionCode: 'BB1632',
		content: 'Before emerging right onto a dual carriageway, make sure that the central reservation is deep enough to protect your vehicle. If it isn\'t, you should treat the dual carriageway as one road and check that it’s clear in both directions before pulling out. Neglecting to do this could place part or all of your vehicle in the path of approaching traffic and cause a collision.'
	},
	{
		questionCode: 'BB1633',
		content: 'Windscreen pillars can completely block your view of pedestrians, motorcyclists and cyclists. You should make a particular effort to look for these road users; don’t just rely on a quick glance.'
	},
	{
		questionCode: 'BB1726',
		content: 'Satnavs can be useful when driving on unfamiliar routes. However, they can also distract you and cause you to lose control if you look at or adjust them while you\'re driving. Set the satnav before starting your journey, or pull up in a safe place before making any changes to it.'
	},
	{
		questionCode: 'AB2012',
	...
	{
		questionCode: 'BB1011',
		content: 'Use the full-beam headlights only when you can be sure that you won’t dazzle other road users.'
	},
	{
		questionCode: 'BB1012',
		content: 'Large, long vehicles need extra room when making turns at junctions. They may move out to the right in order to make a left turn. Keep well back and don\'t attempt to pass them on their left.'
	},
	{
		questionCode: 'BB1013',
		content: 'There are times when other drivers make incorrect or ill-judged decisions. Be tolerant and try not to retaliate or react aggressively. Always consider the safety of other road users, your passengers and yourself.'
	},
	{
		questionCode: 'BB1014',
		content: 'In queuing traffic, your brake lights can dazzle drivers behind you. If you apply your parking brake, you can take your foot off the footbrake. This will turn off the brake lights so that they can\'t dazzle the driver behind you.'
	},
	{
		questionCode: 'BB1016',
		content: 'Keep a steady course to give the driver behind an opportunity to overtake safely. If necessary, slow down. Reacting incorrectly to another driver\'s impatience can lead to danger.'
	},
	{
		questionCode: 'BB1022',
		content: 'Bus-lane signs show the vehicles allowed to use the lane and its times of operation. Where no times are shown, the bus lane is in operation 24 hours a day.'
	},
	{
		questionCode: 'BB1026',
		content: 'If someone in charge of animals asks you to stop, you should do so and switch off your engine. Animals are unpredictable and startle easily; they could turn and run into your path or into the path of another moving vehicle.'
	},
	{
		questionCode: 'BB1027',
		content: 'Horses can be startled by the sound of a car engine or the rush of air caused by a vehicle passing too closely. Keep well back and only pass when it\'s safe. Leave them plenty of room; you may have to use the other side of the road to go past safely.'
	},
	{
		questionCode: 'BB1440',
		content: 'As you approach a zebra crossing, look for pedestrians waiting to cross. Where you can see them, slow down and prepare to stop. Be especially careful of children and older people, who may have difficulty judging when it\'s safe to cross.'
	},
	{
		questionCode: 'BB1444',
		content: 'Try to anticipate what other drivers might do. Look and plan ahead so that you\'re ready to respond safely if a hazard develops. Be tolerant of road users who make mistakes.'
	},
	{
		questionCode: 'BB1555',
		content: 'A sensor will automatically detect that the pedestrians have reached a safe position. Don\'t drive on until the green light shows and it\'s safe for you to do so.'
	},
	{
		questionCode: 'BB1591',
		content: 'You should be aware of all the warning lights and visual aids on the vehicle you\'re driving. If you\'re driving a vehicle for the first time, you should familiarise yourself with all the controls, warning lights and visual aids before you set off.'
	},
	{
		questionCode: 'BB1636',
		content: 'In good, dry conditions, a driver needs to keep a distance of at least two seconds from the car in front. This should allow enough space for you to stop if the driver in front has to stop suddenly.'
	},
	{
		questionCode: 'BB1637',
		content: 'If you follow another vehicle with your headlights on full beam, they could dazzle the driver. Leave a safe distance and make sure that the light from your dipped beam falls short of the vehicle in front.'
	},
	{
		questionCode: 'BB1638',
		content: 'If you’re driving a slow-moving vehicle along a narrow road, try not to hold up faster traffic. If you see vehicles following behind, pull over in a safe place and let the traffic pass before continuing. Don\'t wave other traffic past – this could be dangerous if you or they haven’t noticed a hazard ahead.'
	},
	{
		questionCode: 'BB1642',
		content: 'Diesel fuel can spill out if your filler cap isn\'t secured properly. This is most likely to occur on bends, junctions and roundabouts, where it will make the road slippery, especially if it\'s wet. At the end of a spell of dry weather, road surfaces may be especially slippery where diesel has been spilled but it hasn’t been washed away by rain.'
	},
	{
		questionCode: 'BB1643',
		content: 'When learning to drive, it\'s a good idea to practise filling your car with fuel. Ask your instructor if you can use a petrol station and fill the fuel tank yourself. You need to know where the filler cap is on the car you\'re driving, so you know which side of the pump to park at. Take care not to overfill the tank and make sure you secure the filler cap correctly, so that no fuel leaks onto the road while you\'re driving.'
	},
	{
		questionCode: 'BB1725',
		content: 'Competitive driving increases the risks to everyone and is the opposite of responsible, considerate and defensive driving. Defensive driving is about questioning the actions of other road users and being prepared for the unexpected. Don\'t be taken by surprise.'
	},
	{
		questionCode: 'AB2045',
	...
	{
		questionCode: 'BB1036',
		content: 'Consult the vehicle handbook or a garage before driving the vehicle any further. Only drive to a garage if it\'s safe to do so. If you aren\'t sure, get expert help.'
	},
	{
		questionCode: 'BB1039',
		content: 'If this light comes on, you should have the brake system checked immediately. A faulty braking system could have dangerous consequences.'
	},
	{
		questionCode: 'BB1043',
		content: 'When you’re going to drive, make sure that you’re wearing suitable clothing.\r\nComfortable shoes will ensure that you have proper control of the foot pedals.'
	},
	{
		questionCode: 'BB1045',
		content: 'If you’re involved in a collision, head restraints will reduce the risk of neck injury. They must be properly adjusted. Make sure they aren’t positioned too low: in a crash, this could cause damage to the neck.'
	},
	{
		questionCode: 'BB1048',
		content: 'If you find that your vehicle bounces as you drive around a corner or bend in the road, the shock absorbers might be worn. To test your shock absorbers, sharply press down and release above each wheel. If the vehicle continues to bounce, take it to be checked by a qualified mechanic.'
	},
	{
		questionCode: 'BB1052',
		content: 'A roof rack increases your car\'s wind resistance. This will cause an increase in fuel consumption, so you should remove it when it isn\'t being used. An aerodynamically designed roof rack or box will help reduce wind resistance to a minimum, but the rack or box should still be removed when it isn\'t in use.'
	},
	{
		questionCode: 'BB1278',
	...
	{
		questionCode: 'BB1279',
		content: 'Car tyres must have sufficient depth of tread to give them a good grip on the road surface. The legal minimum for cars is 1.6 mm. This depth should be across the central three-quarters of the breadth of the tyre and around the entire circumference.'
	},
	{
		questionCode: 'BB1280',
		content: 'Seat belts save lives and reduce the risk of injury. If you\'re carrying passengers under 14 years old, it\'s your responsibility as the driver to ensure that their seat belts are fastened or they\'re seated in an approved child restraint.'
	},
	{
		questionCode: 'BB1301',
		content: 'Rapid acceleration and heavy braking lead to increased \r\n• fuel consumption \r\n• wear on your vehicle. \r\nHaving your vehicle serviced regularly will maintain its efficiency, produce cleaner emissions and reduce the risk of a breakdown.'
	},
	{
		questionCode: 'BB1302',
		content: 'If you don\'t have your vehicle serviced regularly, the engine will gradually become less efficient. This will cause increased fuel consumption and, in turn, an increase in the amount of harmful emissions it produces.'
	},
	{
		questionCode: 'BB1303',
		content: 'Try not to use your car as a matter of routine. For shorter journeys, consider walking or cycling instead - this is much better for both you and the environment.'
	},
	{
		questionCode: 'BB1304',
		content: 'Wasting fuel costs you money and also causes unnecessary pollution. Ensuring your tyres are correctly inflated, avoiding carrying unnecessary weight and removing a roof rack that\'s not in use will all help to reduce your fuel consumption.'
	},
	{
		questionCode: 'BB1347',
		content: 'Unless exempt, you and your passengers must wear a seat belt (or suitable child restraint). The seat belts in your car must be in good condition and working properly; they’ll be checked during its MOT test.'
	},
	{
		questionCode: 'BB1348',
		content: 'Your vehicle will use less fuel if you avoid heavy acceleration. The higher the engine revs, the more fuel you\'ll use. Using the same gear, and covering the same distance, a vehicle travelling at 70 mph will use about 15% more fuel than it would at 50 mph. However, don’t travel so slowly that you inconvenience or endanger other road users.'
	},
	{
		questionCode: 'BB1368',
		content: 'The brakes on your vehicle must be effective and properly adjusted. If your vehicle pulls to one side when braking, take it to be checked by a qualified mechanic as soon as you can.'
	},
	{
		questionCode: 'BB1392',
		content: 'If your wheels are out of balance, it will cause the steering to vibrate at certain speeds. This isn\'t a fault that will put itself right, so take your vehicle to a garage or tyre fitter to have the wheels rebalanced.'
	},
	{
		questionCode: 'BB1393',
		content: 'Turning the steering wheel when the car isn\'t moving is known as dry steering. It can cause unnecessary wear to the tyres and steering mechanism.'
	},
	{
		questionCode: 'BB1414',
		content: 'If you have to leave valuables in your car, lock them out of sight. This is the best way to deter an opportunist thief.'
	},
	{
		questionCode: 'BB1416',
		content: 'Having your car registration number etched on all your windows is a cheap and effective way to deter professional car thieves.'
	},
	{
		questionCode: 'BB1418',
		content: 'Never leave the vehicle registration document inside your car. This document would help a thief to dispose of your car more easily.'
	},
	{
		questionCode: 'BB1430',
		content: 'An unlocked car is an open invitation to thieves. Leaving the keys in the ignition not only makes your car easy to steal but could also invalidate your insurance.'
	},
	{
		questionCode: 'BB1500',
		content: 'Harsh braking, frequent gear changes and harsh acceleration increase fuel consumption. A car uses less fuel when travelling at a constant low speed in an appropriate high gear. \r\nYou need to look well ahead so you’re able to anticipate hazards early. Easing off the accelerator and timing your approach at junctions, for example, can reduce the fuel consumption of your vehicle.'
	},
	{
		questionCode: 'BB1508',
		content: 'It\'s illegal to pour engine oil down any drain. Oil is a pollutant and harmful to wildlife. Dispose of it safely at an authorised site.'
	},
	{
		questionCode: 'BB1511',
		content: 'Emission tests are carried out to make sure your vehicle’s engine is operating efficiently. This ensures the pollution produced by the engine is kept to a minimum. If your vehicle isn\'t serviced regularly, it may fail the MOT emissions test.'
	},
	{
		questionCode: 'BB1512',
		content: 'By looking well ahead and recognising hazards in good time, you can avoid late and heavy braking. Watch the traffic flow and look well ahead for potential hazards so you can control your speed in good time. Avoid over-revving the engine and accelerating harshly, as this increases wear to the engine and uses more fuel.'
	},
	{
		questionCode: 'BB1557',
		content: 'All vehicles need to be serviced to keep working efficiently. An efficient engine uses less fuel and produces fewer harmful emissions than an engine that\'s running inefficiently. Keeping the vehicle serviced to the manufacturer\'s schedule should also keep it reliable and reduce the chance of it breaking down.'
	},
	{
		questionCode: 'BB1558',
		content: 'Road humps are there for a reason – to protect vulnerable road users by reducing the speed of traffic. Don’t accelerate harshly between the humps. Put the safety of others first and maintain a reduced speed throughout the zone.'
	},
	{
		questionCode: 'BB1602',
		content: 'An engine can use more oil during long journeys than on shorter trips. Insufficient engine oil is potentially dangerous: it can lead to excessive wear, mechanical breakdown and expensive repairs.\r\nMost cars have a dipstick to allow the oil level to be checked. If not, you should refer to the vehicle handbook.'
	},
	{
		questionCode: 'BB1603',
		content: 'It’s an offence to park on the zigzag lines of a zebra crossing. You\'ll be causing an obstruction by obscuring the view of both pedestrians and drivers.'
	},
	{
		questionCode: 'BB1604',
	...
	{
		questionCode: 'BB1607',
		content: 'Whenever possible, leave your car in a secure car park. This will help deter thieves.'
	},
	{
		questionCode: 'BB1609',
		content: 'Don’t park your vehicle where it may obstruct access to a business or property. Think carefully before you slow down and stop. Look at road markings and signs to ensure that you aren’t parking illegally.'
	},
	{
		questionCode: 'BB1640',
		content: 'In a collision, rapid deceleration will violently throw vehicle occupants forward and then backwards as the vehicle stops. Seat belts and airbags protect occupants against the forward movement. Head restraints should be adjusted so they give maximum protection to the head and neck during the backward movement.'
	},
	{
		questionCode: 'BB1644',
		content: 'Avoid using your car for short journeys. On a short journey, the engine is unlikely to warm up fully and will therefore be running less efficiently. This will result in the car using more fuel and emitting higher levels of harmful emissions.'
	},
	{
		questionCode: 'BB1646',
		content: 'Using a vehicle for short journeys means the engine doesn\'t have time to reach its normal operating temperature. When an engine is running below its normal operating temperature, it produces increased amounts of pollution. Walking and cycling don\'t create pollution and have health benefits as well.'
	},
	{
		questionCode: 'BB1647',
	...
	{
		questionCode: 'BB1653',
		content: 'Having your vehicle broken into or stolen can be very distressing and inconvenient. Avoid leaving your vehicle unattended in poorly lit areas.'
	},
	{
		questionCode: 'BB1654',
		content: 'The Vehicle Watch scheme helps to reduce the risk of your car being stolen. By displaying high-visibility Vehicle Watch stickers in your car, you\'re inviting the police to stop your vehicle if it\'s seen in use between midnight and 5 am.'
	},
	{
		questionCode: 'BB1655',
		content: 'Although carbon dioxide is still produced, a catalytic converter fitted to the exhaust system reduces the toxic and polluting gases by up to 90%.'
	},
	{
		questionCode: 'BB1710',
		content: 'By driving smoothly, you\'ll not only save about 15% of your fuel but will also reduce the amount of wear and tear on your vehicle and the level of pollution it produces. You\'re also likely to feel more relaxed and have a more pleasant journey.'
	},
	{
		questionCode: 'BB1711',
		content: 'Missing out intermediate gears, when appropriate, helps to reduce the amount of time spent accelerating and decelerating - the times when your vehicle uses the most fuel.'
	},
	{
		questionCode: 'BB1722',
		content: 'Fuel-efficient driving is all about looking and planning further ahead. This helps raise your hazard awareness and reduces the need for late and heavy braking. This will make your journeys more comfortable, as well as considerably reducing your fuel bills and reducing emissions that can damage the environment.'
	},
	{
		questionCode: 'BB1723',
		content: 'The emphasis is on hazard awareness and planning ahead. By looking well ahead, you\'ll have plenty of time to deal with hazards safely and won’t need to brake sharply. This will also reduce damage to the environment.'
	},
	{
		questionCode: 'BB1737',
		content: 'Trailers and caravans may be left in storage over the winter months, and tyres can deteriorate. It’s important to check their tread depth and also their pressures and general condition. The legal tread depth of 1.6 mm applies to the central three-quarters of a tyre\'s breadth, over its entire circumference.'
	},
	{
		questionCode: 'BB1741',
		content: 'Accelerating uses a lot of fuel, so always try to use the accelerator smoothly. Taking your foot off the accelerator allows the momentum of the car to take you forward, especially when going downhill. This can save a considerable amount of fuel without any loss of control over the vehicle.'
	},
	{
		questionCode: 'BB1752',
		content: 'If you have adult passengers, it\'s their responsibility to wear a seat belt, but you should still remind them to use one as they get in the car. It\'s your responsibility to make sure that all children in your car are secured with an appropriate restraint. Exemptions are allowed for those with a medical exemption certificate.'
	},
	{
		questionCode: 'BB1755',
		content: 'Passengers should always be secured and safe. Children should be encouraged to fasten their seat belts or approved restraints themselves from an early age, so that it becomes a matter of routine. As the driver, you must check that they\'re fastened securely. It\'s your responsibility.'
	},
	{
		questionCode: 'BB1756',
		content: 'Too much oil will lead to increased pressure in the engine. This could damage oil seals and lead to oil leaks. Any excess oil should be drained off.'
	},
	{
		questionCode: 'BB1763',
		content: 'In journeys of unexpected necessity, and when a correct child restraint isn\'t available, the child must sit on the rear seat and use an adult seat belt. In a collision, unrestrained objects and people can cause serious injury or even death.'
	},
	{
		questionCode: 'BB1765',
		content: 'As the driver, it\'s your responsibility to make sure that children are secure and safe in your vehicle. Make yourself familiar with the rules. When children are carried on the back seat, there are a few very exceptional cases when an adult seat belt can be used instead of a correct child restraint.'
	},
	{
		questionCode: 'BB1769',
		content: 'If your vehicle is stationary and is likely to remain so for some time, you must switch off the engine unless you\'re stationary in traffic or diagnosing a fault.'
	},
	{
		questionCode: 'BB1770',
		content: 'It\'s illegal to fit a rear-facing baby seat into a passenger seat protected by an active frontal airbag. If the airbag activates, it could cause serious injury or even death to the child. You must secure it in a different seat or deactivate the relevant airbag. Follow the manufacturer\'s advice when fitting a baby seat.'
	},
	{
		questionCode: 'BB1777',
		content: 'When you leave your vehicle parked on a road, switch off the engine and secure the vehicle. Make sure no valuables are visible, shut all the windows, lock the vehicle, and set the alarm if the vehicle has one.'
	},
	{
		questionCode: 'BB4417',
		content: 'ESC is a computer controlled technology that detects reduced traction and automatically makes corrective adjustments to prevent loss of control. The ESC lamp comes on to alert the driver that the system has activated and the car is approaching its handling limits. It’s a powerful driver aid but it cannot save a car once its traction limits have been exceeded.'
	},
	{
		questionCode: 'AB2076',
	...
	{
		questionCode: 'BB1059',
		content: 'If you’re travelling on an icy road, extra caution will be required to avoid loss of control. Keeping your speed down and using the highest gear possible will reduce the risk of the tyres losing their grip on this slippery surface.'
	},
	{
		questionCode: 'BB1060',
		content: 'Skidding is usually caused by driver error. You should always adjust your driving to take account of the road and weather conditions.'
	},
	{
		questionCode: 'BB1062',
		content: 'Harsh use of the accelerator, brakes or steering is likely to lead to skidding, especially on slippery surfaces. Avoid steering and braking at the same time. In icy conditions, it’s very important that you constantly assess what’s ahead so that you can take appropriate action in plenty of time.'
	},
	{
		questionCode: 'BB1066',
		content: 'Driving in bad weather increases your risk of having a collision. If you absolutely have to travel, clear your lights, mirrors, number plates and windows of any snow or ice, so that you can see and be seen.'
	},
	{
		questionCode: 'BB1068',
		content: 'If you attempt to move off in a low gear, there\'ll be more torque (turning force) at the driven wheels than if you use a higher gear. More torque makes it easier for the tyres to lose grip and so spin the wheels.'
	},
	{
		questionCode: 'BB1069',
		content: 'In snowy conditions, be careful with the steering, accelerator and brakes. Braking sharply while you\'re driving on snow is likely to make your car skid.'
	},
	{
		questionCode: 'BB1070',
		content: 'By driving all four wheels, the vehicle has maximum grip on the road. This grip is especially helpful when travelling on slippery or uneven surfaces. However, having four-wheel drive doesn\'t replace the skills you need to drive safely.'
	},
	{
		questionCode: 'BB1073',
		content: 'When driving down a steep hill, gravity will cause your vehicle to speed up. This will make it more difficult for you to stop. To help keep your vehicle\'s speed under control, select a lower gear to give you more engine braking and make careful use of the brakes.'
	},
	{
		questionCode: 'BB1075',
		content: 'Turning the wheels towards the kerb will allow them to act as a chock, preventing any forward movement of the vehicle. It will also help to leave your car in gear, or select ‘Park’ if you have an automatic.'
	},
	{
		questionCode: 'BB1076',
		content: 'Many towns have road humps as part of traffic-calming measures, designed to slow down traffic. Reduce your speed when driving over them. If you go too fast, you could lose control or damage your car. Look out for pedestrians or cyclists while you\'re driving in these areas.'
	},
	{
		questionCode: 'BB1317',
		content: 'Poor contact with the road surface could cause one or more of the tyres to lose grip on the road. This is more likely to happen when braking in poor weather conditions and when the road has a loose, slippery or uneven surface.'
	},
	{
		questionCode: 'BB1322',
		content: 'You may have to stop in an emergency due to a misjudgement by another driver or a hazard arising suddenly, such as a child running out into the road. If your vehicle has anti-lock brakes, you should apply the brakes immediately and keep them firmly applied until you stop.'
	},
	{
		questionCode: 'BB1351',
		content: 'If your brakes have been thoroughly soaked, you should check that they\'re working properly before you build up speed again. Before you do this, remember to check your mirrors and consider what\'s behind you.'
	},
	{
		questionCode: 'BB1396',
		content: 'Drive extremely carefully when the roads are icy. When travelling on ice, tyres make virtually no noise and the steering feels light and unresponsive.\r\nIn icy conditions, be very gentle when braking, accelerating and steering.'
	},
	{
		questionCode: 'BB1405',
		content: 'If you drive at speed in very wet conditions, your steering may suddenly feel lighter than usual. This means that the tyres have lifted off the surface of the road and are floating on the surface of the water. This is known as aquaplaning. Reduce speed but don’t brake until your steering returns to normal.'
	},
	{
		questionCode: 'BB1448',
		content: 'Extra care should be taken in wet weather. On wet roads, your stopping distance could be double that in dry conditions.'
	},
	{
		questionCode: 'BB1657',
		content: 'One way of checking there\'s a safe distance between you and the vehicle in front is to use the two-second rule. To check for a two-second time gap, choose a stationary object ahead, such as a bridge or road sign. When the car in front passes the object, say \'Only a fool breaks the two-second rule\'. If you reach the object before you finish saying the phrase, you\'re too close and need to increase the gap.'
	},
	{
		questionCode: 'BB1659',
		content: 'When driving on downhill stretches of road, selecting a lower gear gives increased engine braking. This will prevent excessive use of the brakes, which become less effective if they overheat.'
	},
	{
		questionCode: 'BB1660',
		content: 'If you have ABS and need to stop in an emergency, keep your foot firmly on the brake pedal until the vehicle has stopped. When the ABS operates, you may hear a grating sound and feel vibration through the brake pedal. This is normal and you should maintain pressure on the brake pedal until the vehicle stops.'
	},
	{
		questionCode: 'BB1681',
		content: 'When surface spray reduces visibility, switch on your headlights on dipped beam. This will help other road users to see you.'
	},
	{
		questionCode: 'BB1742',
	...
	{
		questionCode: 'BB2894',
		content: 'In strong winds, riders of two-wheeled vehicles are particularly vulnerable. When you overtake them, allow plenty of room. Check to the left as you pass to make sure they\'re safe.'
	},
	{
		questionCode: 'AB2085',
	...
	{
		questionCode: 'AB2701',
		content: 'This sign is found on slow-moving or stationary works vehicles. If you wish to overtake it, do so on the left, as indicated. Be aware that there might be workmen in the area.'
	},
	{
		questionCode: 'AB2716',
	...
	{
		questionCode: 'AB2723',
		content: 'Traffic-calming measures such as road humps, chicanes and narrowings are intended to slow drivers down to protect vulnerable road users. Don\'t speed up until you reach the end of the traffic-calmed zone.'
	},
	{
		questionCode: 'AB2724',
	...
	{
		questionCode: 'BB1081',
		content: 'The continuous white line shows the edge of the carriageway. It can be especially useful when visibility is restricted, such as at night or in bad weather. It\'s discontinued in some places; for example, at  junctions, lay-bys, entrances or other openings.'
	},
	{
		questionCode: 'BB1085',
		content: 'The steady amber light will be followed by twin flashing red lights that mean you must stop. An alarm will also sound to alert you to the fact that a train is approaching.'
	},
	{
		questionCode: 'BB1087',
		content: 'Hold back and allow the cyclist to move off. Some junctions have special areas marked across the front of the traffic lane. These allow cyclists to wait for the lights to change and move off ahead of other traffic.'
	},
	{
		questionCode: 'BB1095',
		content: 'If you\'ve been in a queue of traffic and are about to turn left, check your nearside for cyclists as they often filter past on the nearside of slow-moving or stationary vehicles.'
	},
	{
		questionCode: 'BB1096',
		content: 'Traffic could be turning off or pulling out ahead of you, to the left or right. Vehicles turning left will be slowing down before the junction, and any vehicles turning right may have to stop to allow oncoming traffic to clear. Be prepared for this, as you might have to slow down or stop behind them.'
	},
	{
		questionCode: 'BB1099',
		content: 'Be courteous and allow the traffic to merge into the left-hand lane.'
	},
	{
		questionCode: 'BB1100',
		content: 'On some busy roads, lane control signals are used to vary the number of lanes available to give priority to the main traffic flow. A green arrow indicates that the lane is available to traffic facing the signal. A white diagonal arrow means that the lane is closed ahead and traffic should move to the next lane on the left. A red cross means that the lane is closed to traffic facing the signal.'
	},
	{
		questionCode: 'BB1109',
		content: 'Alcohol will stay in your body for several hours and may make you unfit to drive later in the day. Drinking during the day will also affect your performance at work or study.'
	},
	{
		questionCode: 'BB1112',
		content: 'You\'ve shown that you\'re a risk to yourself and others on the road. For this reason, insurance companies may charge you a higher premium.'
	},
	{
		questionCode: 'BB1113',
		content: 'Drinking black coffee or waiting a few hours won\'t make any difference. Alcohol takes time to leave the body. \r\nA driver who has been drinking should go home by public transport or taxi. They might even be unfit to drive the following morning.'
	},
	{
		questionCode: 'BB1115',
		content: 'You aren\'t fit to drive if you\'re taking medicine that makes you drowsy. Check with your doctor if you\'re unsure. You mustn\'t put other road users, your passengers or yourself at risk.'
	},
	{
		questionCode: 'BB1116',
		content: 'You shouldn\'t drive if you\'re taking medicine that could cause you to feel drowsy at the wheel. Ask someone else to drive or, if that isn\'t possible, find another way to get home.'
	},
	{
		questionCode: 'BB1117',
		content: 'Only drive if you\'re fit to do so. Driving when you\'re ill or taking some medicines can affect your concentration and judgement. It may also cause you to become drowsy or even fall asleep.'
	},
	{
		questionCode: 'BB1120',
		content: 'You\'ll be putting other road users at risk if you continue to drive when you\'re drowsy. Pull over and stop in a safe place for a rest. Caffeinated drinks and a short nap can temporarily help counter sleepiness. If you\'re driving a long distance, think about finding some accommodation so you can rest for longer before continuing your journey.'
	},
	{
		questionCode: 'BB1121',
		content: 'If you feel yourself becoming tired or sleepy, you should leave the motorway at the next exit or services and stop for a rest. If you have to drive a long way, leave earlier and plan your journey to include rest stops. That way, you\'re less likely to become tired while driving and you\'ll still arrive in good time.'
	},
	{
		questionCode: 'BB1123',
		content: 'All of your concentration should be on your driving. Any pain you feel will distract you, and you should avoid driving when drowsy. The safest course of action is to wait until you\'ve rested and are feeling better before starting your journey.'
	},
	{
		questionCode: 'BB1127',
		content: 'Long-distance driving can be boring. This, coupled with a stuffy, warm vehicle, can make you feel tired and sleepy. Make sure you take rest breaks to help you stay awake and alert. Stop in a safe place before you get to the stage of fighting sleep.'
	},
	{
		questionCode: 'BB1284',
		content: 'If you\'ve taken medicine, never drive without first checking what the side effects might be; they might affect your judgement and perception, and therefore endanger lives.'
	},
	{
		questionCode: 'BB1353',
		content: 'Never reverse or turn your vehicle around in a one-way street. It\'s illegal and could even cause a collision. If you\'ve taken a wrong turn, carry on along the one-way street and find another route, checking the direction signs as you drive. Stop in a safe place if you need to check a map.'
	},
	{
		questionCode: 'BB1380',
		content: 'Looking at road maps while driving is very dangerous. If you aren’t sure of your route, stop in a safe place and check the map. You must not allow anything to take your attention away from the road while you’re driving.'
	},
	{
		questionCode: 'BB1397',
		content: 'White lights at the rear of a car show that the driver has selected reverse gear. The driver is hidden from view so can\'t see you approaching. Sound your horn to warn of your presence, and be ready to stop if the car reverses into your path.'
	},
	{
		questionCode: 'BB1398',
		content: 'If you\'re feeling upset or angry, you\'ll find it much more difficult to concentrate on your driving. You should wait until you\'ve calmed down before starting a journey.'
	},
	{
		questionCode: 'BB1454',
		content: 'Look well ahead and read any road signs as you drive. They\'re there to inform you of what\'s ahead. In this case, you may need to slow down and change direction. \r\nCheck your mirrors so you know what\'s happening around you before you change speed or direction.'
	},
	{
		questionCode: 'BB1455',
		content: 'If another vehicle cuts in sharply, ease off the accelerator and drop back to allow a safe separation distance. Try not to overreact by braking sharply or swerving, as you could lose control. If vehicles behind you are too close or unprepared, it could lead to a crash.'
	},
	{
		questionCode: 'BB1457',
		content: 'If you need to wear glasses for driving, it\'s illegal to drive without them. You must be able to see clearly when you\'re driving.'
	},
	{
		questionCode: 'BB1459',
		content: 'Alcohol can increase confidence to a point where your driving behaviour might become ‘out of character’. Sensible behaviour might change to risk-taking behaviour. Never let yourself or your friends get into this situation.'
	},
	{
		questionCode: 'BB1461',
		content: 'Always check the label or information leaflet for any medication you take. The medicine might affect your driving. If you aren’t sure, ask your doctor or pharmacist.'
	},
	{
		questionCode: 'BB1514',
		content: 'Have your eyesight tested before you start your practical training. Then, throughout your driving life, have checks periodically, as your vision may change.'
	},
	{
		questionCode: 'BB1546',
		content: 'If you\'re driving at night or in poor visibility, tinted lenses will reduce the efficiency of your vision by reducing the amount of light reaching your eyes.'
	},
	{
		questionCode: 'BB1564',
		content: 'Both recreational drugs and prescribed medicine can affect your concentration. It\'s also an offence to drive with certain drugs in your body and a positive test could lead to a conviction.'
	},
	{
		questionCode: 'BB1568',
		content: 'Having very poor eyesight will have a serious effect on your ability to drive safely. If you can\'t meet the driver\'s eyesight requirements, you must tell DVLA (or DVA in Northern Ireland).'
	},
	{
		questionCode: 'BB1575',
		content: 'Hazard warning lights are an important safety feature and should be used if you\'ve broken down and are causing an obstruction. Don’t use them as an excuse to park illegally. You may also use them on motorways to warn traffic behind you of danger ahead.'
	},
	{
		questionCode: 'BB1576',
		content: 'You should slow right down, and stop if necessary, at any junction where your view is restricted. Edge forward until you can see properly. Only then can you decide whether it\'s safe to go.'
	},
	{
		questionCode: 'BB1596',
		content: '‘Kick down’ selects a lower gear, enabling the vehicle to accelerate faster.'
	},
	{
		questionCode: 'BB1664',
		content: 'The usual two-second time gap increases to four seconds when the roads are wet. If you stay well back, you’ll\r\n• be able to see past the vehicle\r\n• be out of the spray thrown up by the lorry’s tyres\r\n• give yourself more time to stop if the need arises\r\n• increase your chances of being seen by the lorry driver.'
	},
	{
		questionCode: 'BB1665',
		content: 'Pedestrians walking on a road with no pavement should walk against the direction of the traffic. You can’t see around this bend and if pedestrians are in the road you need to be able to deal with the situation safely. Always keep this in mind and give yourself time to react if a hazard does appear.'
	},
	{
		questionCode: 'BB1666',
		content: 'Allow the traffic to merge into the left-hand lane. Leave enough room so that you can maintain a safe separation distance, even if vehicles pull in ahead of you.'
	},
	{
		questionCode: 'BB1670',
		content: 'Hazard warning lights are an important safety feature. Use them when driving on a motorway to warn traffic behind you of danger ahead. \r\nYou should also use them if your vehicle has broken down and is causing an obstruction.'
	},
	{
		questionCode: 'BB1727',
		content: 'You must be completely sure it\'s safe to emerge. Try to look for traffic through the windows of the parked cars or in the reflections in windows. Keep looking in all directions as you slowly edge forwards until you can see it\'s safe.'
	},
	{
		questionCode: 'BB1743',
		content: 'You must tell DVLA (or DVA in Northern Ireland) if your health is likely to affect your ability to drive. The licensing authority will investigate your situation and then make a decision on whether you\'re fit enough to drive safely.'
	},
	{
		questionCode: 'BB1748',
		content: 'You should always try to keep junctions clear. If you\'re in queuing traffic, make sure that when you stop you leave enough space for traffic to flow in and out of the junction.'
	},
	{
		questionCode: 'BB1779',
		content: 'Never stop on the hard shoulder to rest. If there\'s no service area for several miles, leave the motorway at the next exit and find somewhere safe and legal to pull over.'
	},
	{
		questionCode: 'AB2117',
	...
	{
		questionCode: 'BB1131',
		content: 'If you can\'t tell whether there\'s anything behind you, it\'s always safest to check before reversing. There may be a small child or a low obstruction close behind your car.'
	},
	{
		questionCode: 'BB1132',
		content: 'If you need to reverse into a side road, try to find a place that’s free from traffic and pedestrians. Look all around before and during the manoeuvre. Stop and give way to any pedestrians who want to cross behind you. Avoid waving them across, sounding the horn, flashing your lights or giving any signals that could mislead them and create a dangerous situation.'
	},
	{
		questionCode: 'BB1133',
		content: 'It may not be possible to see a small child through the rear windscreen of your vehicle. Be aware of this before you reverse. If there are children about, get out and check that it\'s clear before reversing.'
	},
	{
		questionCode: 'BB1135',
		content: 'If you want to turn right from a junction and your view is restricted, stop. Ease forward until you can see – something might be approaching.\r\nIf you don\'t know, don\'t go.'
	},
	{
		questionCode: 'BB1136',
		content: 'A motorcyclist could be riding along the outside of the queue. Always check your mirror before turning, as situations behind you can change while you\'ve been waiting to turn.'
	},
	{
		questionCode: 'BB1139',
		content: 'The flashing amber light allows pedestrians already on the crossing to get to the other side before a green light shows to the traffic. Be aware that some pedestrians, such as older people and young children, need longer to cross. Let them do this at their own pace.'
	},
	{
		questionCode: 'BB1140',
		content: 'At a pelican crossing, the green light means you may proceed as long as the crossing is clear. If someone hasn’t finished crossing, be patient and wait for them, whether they\'re disabled or not.'
	},
	{
		questionCode: 'BB1142',
		content: 'Beware of children playing in the street and running out into the road. If a ball bounces out from the pavement, slow down and be prepared to stop. Don’t encourage anyone to retrieve it. Other road users may not see your signal and you might lead a child into a dangerous situation.'
	},
	{
		questionCode: 'BB1145',
		content: 'In some circumstances, your indicators may be difficult to see and another road user may not realise you\'re about to turn. A final check in your mirror and blind spot can help you to see an overtaking vehicle, so that you can avoid turning across their path.'
	},
	{
		questionCode: 'BB1147',
		content: 'In queuing traffic, motorcyclists could be passing you on either side. Use your mirrors and check your blind area before changing lanes or changing direction.'
	},
	{
		questionCode: 'BB1148',
		content: 'If you see a bus ahead, watch out for pedestrians. They might not be able to see you if they’re behind the bus.'
	},
	{
		questionCode: 'BB1149',
		content: 'When you decide to overtake a horse rider, make sure you can do so safely before you move out. Leave them plenty of room and pass slowly. Passing too close could startle the horse and unseat the rider.'
	},
	{
		questionCode: 'BB1516',
		content: 'If you’re driving in high winds, be aware that the conditions might make a motorcyclist (or cyclist) swerve or wobble. Take this into consideration if you’re following or wish to overtake a two-wheeled vehicle.'
	},
	{
		questionCode: 'BB1563',
		content: 'Motorcyclists and cyclists are often more difficult to see at junctions. They\'re easily hidden from view and you may not be able to see them approaching a junction if your view is partially blocked; for example, by other traffic.'
	},
	{
		questionCode: 'BB1577',
		content: 'Parking here would block other road users\' view of the school entrance and would endanger the lives of children on their way to and from school.'
	},
	{
		questionCode: 'BB1672',
		content: 'Scan the road as you drive. Try to anticipate hazards by being aware of the places where they\'re likely to occur. You’ll then be able to react in good time.'
	},
	{
		questionCode: 'BB1674',
		content: 'The interior mirror of most vehicles can be set to an anti-dazzle position. You\'ll still be able to see the lights of the traffic behind you, but the dazzle will be greatly reduced.'
	},
	{
		questionCode: 'BB1678',
		content: 'You should slow down and be prepared to stop, as you would for an able-bodied person. Don’t wave them across, as other traffic may not stop.'
	},
	{
		questionCode: 'AB2176',
	...
	{
		questionCode: 'BB1157',
		content: 'Windy weather affects motorcyclists more than other vehicles. In windy conditions, high-sided vehicles cause air turbulence. You should keep well back, as the motorcyclist could be blown off course.'
	},
	{
		questionCode: 'BB1162',
		content: 'As you approach, look out for any signal the driver might make. If you pass the vehicle, watch out for pedestrians attempting to cross the road from behind the bus. They’ll be hidden from view until the last moment.'
	},
	{
		questionCode: 'BB1399',
	...
	{
		questionCode: 'BB1578',
		content: 'You should take extra care when you first encounter trams. You\'ll have to get used to dealing with a different traffic system. \r\nBe aware that trams can accelerate and travel very quickly, and they can\'t change direction to avoid obstructions.'
	},
	{
		questionCode: 'BB1679',
		content: 'Towing a large trailer or caravan can greatly reduce your view of the road behind. You may need to fit extended-arm side mirrors so that you can see clearly behind and down both sides of the caravan or trailer.'
	},
	{
		questionCode: 'BB1680',
		content: 'You must make sure that other road users can see you, but you don\'t want to dazzle them. Use your dipped headlights during the day if visibility is poor. If visibility falls below 100 metres (328 feet), you may use your rear fog lights, but don’t forget to turn them off when the visibility improves.'
	},
	{
		questionCode: 'BB1720',
		content: 'Cyclists, and motorcyclists, are very vulnerable in high winds. They can easily be blown well off course and veer into your path. Always allow plenty of room when overtaking them. Passing too close could cause a draught and unbalance the rider.'
	},
	{
		questionCode: 'AB2199',
	...
	{
		questionCode: 'BB1166',
		content: 'The engine will need more power to pull the vehicle up the hill. When approaching a steep hill you should select a lower gear to help maintain your speed. You should do this without hesitation, so that you don’t lose too much speed before engaging the lower gear.'
	},
	{
		questionCode: 'BB1168',
		content: 'The draught caused by other vehicles – particularly those with high sides – could be strong enough to push you out of your lane. Be prepared for a sudden gust of wind as you overtake large vehicles. Keep both hands on the steering wheel to help you keep full control.'
	},
	{
		questionCode: 'BB1177',
		content: 'If you’re following another road user in fog, stay well back. The driver in front won’t be able to see hazards until they’re close and might need to brake suddenly. Also, the road surface is likely to be wet and could be slippery.'
	},
	{
		questionCode: 'BB1181',
		content: 'If you have to park your vehicle in foggy conditions, try to find a place to park off the road. If this isn’t possible, park on the road facing in the same direction as the traffic. Leave your parking lights switched on and make sure they\'re clean.'
	},
	{
		questionCode: 'BB1186',
		content: 'If the headlights of an oncoming vehicle dazzle you, slow down or, if necessary, stop. Don’t close your eyes or swerve, as you\'ll increase your chances of having a collision. Don\'t flash your headlights either, as this could dazzle other drivers and make the situation worse.'
	},
	{
		questionCode: 'BB1325',
		content: 'Your fog lights must only be used when visibility is reduced to 100 metres (328 feet) or less. You need to be familiar with the layout of your dashboard so you\'re aware if your fog lights have been switched on in error, or you\'ve forgotten to switch them off.'
	},
	{
		questionCode: 'BB1330',
		content: 'Switch off your fog lights if the weather improves, but be prepared to use them again if visibility reduces to less than 100 metres (328 feet).'
	},
	{
		questionCode: 'BB1339',
		content: 'Don’t forget to switch off your fog lights when the weather improves. You could be prosecuted for driving with them on in good visibility. The high intensity of rear fog lights can dazzle drivers behind and make your brake lights difficult to notice.'
	},
	{
		questionCode: 'BB1343',
		content: 'Rear fog lights shine more brightly than normal rear lights, so that they show up in reduced visibility. When the visibility improves, you must switch them off; this stops them dazzling the driver behind.'
	},
	{
		questionCode: 'BB1400',
		content: 'Chains can be fitted to your wheels in snowy conditions. They can help you to move off without wheelspin, or to keep moving in deep snow. You\'ll still need to adjust your driving to suit these conditions.'
	},
	{
		questionCode: 'BB1408',
		content: 'You should brake and slow down before selecting a lower gear. The gear can then be used to keep the speed low and help you control the vehicle. This is particularly helpful on long downhill stretches, where brake fade can occur if the brakes overheat.'
	},
	{
		questionCode: 'BB1433',
	...
	{
		questionCode: 'BB1470',
		content: 'Don\'t travel in icy or snowy weather unless your journey is essential.\r\nDrive extremely carefully when roads are or may be icy. Stopping distances can be ten times greater than on dry roads.'
	},
	{
		questionCode: 'BB1473',
		content: 'If you’re driving on a motorway at night or in poor visibility, you must always use your headlights, even if the road is well lit. Other road users must be able to see you, but you should avoid causing dazzle.'
	},
	{
		questionCode: 'BB1474',
		content: 'If you’re driving behind other traffic on the motorway at night, use dipped headlights. Main-beam headlights will dazzle the other drivers. Your headlights’ dipped beam should fall short of the vehicle in front.'
	},
	{
		questionCode: 'BB1518',
		content: 'Having tyres correctly inflated and in good condition will ensure they have maximum grip on the road; how well your tyres grip the road has a significant effect on your car\'s stopping distance.'
	},
	{
		questionCode: 'BB1579',
		content: 'When you take your foot off the accelerator, engines have a natural resistance to turn, caused mainly by the cylinder compression. Changing to a lower gear requires the engine to turn faster and so it will have greater resistance than when it\'s made to turn more slowly. When going downhill, changing to a lower gear will therefore help to keep the vehicle\'s speed in check.'
	},
	{
		questionCode: 'BB1597',
		content: 'Only use your fog lights when visibility is seriously reduced. Use dipped headlights in poor conditions because this helps other road users to see you without the risk of causing dazzle.'
	},
	{
		questionCode: 'BB1598',
		content: 'Rear fog lights make it easier to spot a vehicle ahead in foggy conditions. Avoid the temptation to use other vehicles\' lights as a guide, as they may give you a false sense of security.'
	},
	{
		questionCode: 'BB1621',
		content: 'Consider whether the increased risk is worth it. If the weather conditions are bad and your journey isn’t essential, then don\'t drive. If you have to drive, make sure you\'re well prepared in case you get stuck.'
	},
	{
		questionCode: 'BB1682',
		content: 'If you have to drive in fog, switch your dipped headlights on and keep all your windows clear. You should always be able to pull up within the distance you can see ahead.'
	},
	{
		questionCode: 'BB1683',
		content: 'You must turn off your fog lights if visibility is more than 100 metres (328 feet). Be prepared for the fact that the fog may be patchy and you may need to turn them on again if the fog returns.'
	},
	{
		questionCode: 'BB1685',
		content: 'If your rear fog lights are left on when it isn’t foggy, the glare they cause makes it difficult for road users behind to know whether you’re braking or you’ve just forgotten to turn off your rear fog lights. This can be a particular problem on wet roads and on motorways. If you leave your rear fog lights on at night, road users behind you are likely to be dazzled and this could put them at risk.'
	},
	{
		questionCode: 'BB1686',
	...
	{
		questionCode: 'BB1717',
		content: 'Coasting is when you allow the vehicle to freewheel in neutral or with the clutch pedal depressed. When travelling downhill, this will cause the vehicle to gain speed more quickly as you lose the benefits of engine braking; it may even lead to a loss of control. You shouldn\'t coast, especially when approaching hazards such as junctions or bends and when travelling downhill.'
	},
	{
		questionCode: 'BB1718',
		content: 'In normal conditions, a ford can be crossed quite safely by driving through it slowly. The water may affect your brakes, so when you\'re clear of the ford, test them before you resume normal driving.'
	},
	{
		questionCode: 'BB1744',
		content: 'Try to look and plan well ahead. Plan your approach to hazards and select the correct gear in good time. This will help give you the control you need to deal with anything unexpected that may occur.'
	},
	{
		questionCode: 'BB1749',
		content: 'You must use dipped headlights when daytime visibility is seriously reduced, generally to 100 metres (328 feet) or less. You may also use front or rear fog lights, but they must be switched off when visibility improves.'
	},
	{
		questionCode: 'AB2219',
	...
	{
		questionCode: 'BB1193',
		content: 'If you’re towing a small, light trailer, it won’t reduce your vehicle’s performance by very much and it may not be visible in your mirrors. However, strong winds or buffeting from large vehicles might cause the trailer to snake from side to side. Be aware of your speed and don’t exceed the reduced speed limit imposed on vehicles towing trailers.'
	},
	{
		questionCode: 'BB1197',
		content: 'You should drive in the left-hand lane whenever possible. Only use the other lanes for overtaking or when directed to do so by signals. Using other lanes when the left-hand lane is empty can frustrate drivers behind you.'
	},
	{
		questionCode: 'BB1198',
		content: 'Using your hazard warning lights, as well as your brake lights, will give the traffic behind an extra warning of the problem ahead. Only use them for long enough for your warning to be seen.'
	},
	{
		questionCode: 'BB1199',
		content: 'Park as far to the left as you can and leave the vehicle by the nearside door. Don\'t attempt even simple repairs. Instead, walk to an emergency telephone on your side of the road and phone for help. While waiting for help to arrive, stay by your car, keeping well away from the carriageway and hard shoulder.'
	},
	{
		questionCode: 'BB1204',
		content: 'It\'s illegal to reverse, cross the central reservation or drive against the traffic flow on a motorway. If you miss your exit, carry on until you reach the next one. Ask yourself why you missed your exit – if you think that your concentration is fading, take a break before continuing your journey.'
	},
	{
		questionCode: 'BB1481',
		content: 'If you can’t get your vehicle onto the hard shoulder, use your hazard warning lights to warn others. Leave your vehicle only when you can safely get clear of the carriageway. Don\'t try to repair the vehicle or attempt to place any warning device on the carriageway.'
	},
	{
		questionCode: 'BB1520',
		content: 'Before you start your journey, make sure that your vehicle can cope with the demands of high-speed driving. You should check a number of things; the main ones being fuel, oil, water and tyres. You also need to plan rest stops if you’re making a long journey.'
	},
	{
		questionCode: 'BB1523',
		content: 'If the vehicle in front shows its hazard warning lights, there may be an incident, stopped traffic or queuing traffic ahead. By keeping a safe distance from the vehicle in front, you\'re able to look beyond it and see any hazards well ahead.'
	},
	{
		questionCode: 'BB1525',
	...
	{
		questionCode: 'BB1618',
		content: 'You won\'t be able to drive unaccompanied until you\'ve passed your practical driving test. If you haven\'t driven on the motorway while you were learning, ask your instructor to take you for a lesson on the motorway when you\'ve passed your test. Alternatively, you could take part in the Pass Plus scheme. This has been created for new drivers and includes motorway driving. Ask your instructor for details.'
	},
	{
		questionCode: 'BB1688',
		content: 'You should use an emergency telephone when you break down on the motorway; only use your mobile if this isn\'t possible. The emergency services need to know your exact location so they can reach you as quickly as possible. Look for a number on the nearest marker post beside the hard shoulder. Give this number when you call the emergency services.'
	},
	{
		questionCode: 'BB1689',
		content: 'If you\'re towing a caravan or trailer, you mustn\'t use the right-hand lane of a motorway with three or more lanes except in certain specified circumstances, such as when lanes are closed.'
	},
	{
		questionCode: 'BB1690',
		content: 'When approaching a contraflow system, reduce speed in good time and obey all speed limits. You may be travelling in a narrower lane than normal, with no permanent barrier between you and the oncoming traffic. Be aware that the hard shoulder may be used for traffic and the road ahead could be obstructed by slow-moving or broken-down vehicles.'
	},
	{
		questionCode: 'AB2246',
		content: 'This sign doesn\'t tell you the speed limit in figures. You should know the speed limit for the type of road that you\'re on and the type of vehicle that you\'re driving. Study your copy of The Highway Code.'
	},
	{
		questionCode: 'AB2248',
	...
	{
		questionCode: 'BB1206',
		content: 'It\'s illegal to drive on or over a pavement, except to gain access to a property. If you need to cross a pavement, give priority to pedestrians.'
	},
	{
		questionCode: 'BB1207',
		content: 'When you\'re towing a trailer, a reduced speed limit also applies on dual carriageways and motorways. These lower speed limits apply to vehicles pulling all sorts of trailers, including caravans and horse boxes.'
	},
	{
		questionCode: 'BB1209',
		content: 'The speed limit for cars towing caravans or trailers on dual carriageways or motorways is 60 mph. Due to the increased weight and size of the combination, you should plan further ahead. Take care in windy weather, as a strong side wind can make a caravan or large trailer unstable.'
	},
	{
		questionCode: 'BB1213',
		content: 'Parking restrictions apply in a variety of places and situations. Make sure you know the rules and understand where and when restrictions apply. Controlled parking areas will be indicated by signs and road markings. Parking in the wrong place could cause an obstruction and danger to other traffic. It can also result in a fine.'
	},
	{
		questionCode: 'BB1220',
		content: 'While it\'s in operation, other vehicles must not use this part of the carriageway except to pick up or set down passengers. At other times, when the lane isn\'t in operation, you should still be aware that there may be cyclists using the lane. Give them plenty of room as you pass and allow for their movement from side to side, especially in windy weather or on a bumpy road.'
	},
	{
		questionCode: 'BB1225',
		content: 'Your road position can help other road users to anticipate your actions. Keep to the left as you approach a left turn and don\'t swing out into the centre of the road in order to make the turn easier. This could endanger oncoming traffic and may cause other road users to misunderstand your intentions.'
	},
	{
		questionCode: 'BB1226',
		content: 'At a level crossing, flashing red lights mean you must stop. If the train passes but the lights keep flashing, wait. Another train may be coming.'
	},
	{
		questionCode: 'BB1227',
		content: 'Keep going; don’t stop on the crossing. If the warning sounds and the amber lights come on as you’re approaching the crossing, you must stop unless it\'s unsafe to do so. Red flashing lights together with the audible warning mean you must stop.'
	},
	{
		questionCode: 'BB1228',
		content: 'Don’t turn around in a busy street or reverse from a side road into a main road. Find a quiet side road and choose a place to turn around where you won’t obstruct an entrance or exit. Look out for pedestrians and cyclists as well as other traffic.'
	},
	{
		questionCode: 'BB1229',
		content: 'You may remove your seat belt while you\'re carrying out a manoeuvre that includes reversing. However, you must remember to put it back on again before you resume driving.'
	},
	{
		questionCode: 'BB1230',
		content: 'You mustn\'t reverse further than is necessary. You may decide to turn your vehicle around by reversing into an opening or side road. When you reverse, always look all around you and watch for pedestrians. Don’t reverse from a side road into a main road.'
	},
	{
		questionCode: 'BB1232',
		content: 'A small child could be hidden directly behind you, so, if you can\'t see all around your vehicle, get out and have a look. You could also ask someone reliable outside the vehicle to guide you.'
	},
	{
		questionCode: 'BB1233',
		content: 'Don’t reverse into a main road from a side road because your view will be restricted. The main road is likely to be busy and the traffic on it moving quickly.'
	},
	{
		questionCode: 'BB1355',
		content: 'You can wait in the box junction as long as your exit is clear. At some point there\'ll be a gap in the oncoming traffic, or the traffic lights will change, allowing you to proceed.'
	},
	{
		questionCode: 'BB1381',
		content: 'Always check in all directions before reversing. Keep a good lookout throughout the manoeuvre and remember that the front will swing out as you reverse into the side road. Act on what you see and wait if necessary.'
	},
	{
		questionCode: 'BB1435',
		content: 'If you have a garage, use it. Your vehicle is less likely to be a victim of car crime if it\'s in a garage. Also, in winter, the windows will be kept free from ice and snow.'
	},
	{
		questionCode: 'BB1527',
		content: 'Urban clearways have their times of operation clearly signed. You may only stop to pick up or set down passengers.'
	},
	{
		questionCode: 'BB1528',
		content: 'It\'s illegal to park in a space reserved for disabled drivers unless you\'re permitted to do so. These spaces are provided for people with limited mobility, who may need extra space to get in and out of their vehicle.'
	},
	{
		questionCode: 'BB1554',
		content: 'Pull into the nearest passing place on the left if you meet another vehicle on a narrow road. If the nearest passing place is on the right, wait opposite it.'
	},
	{
		questionCode: 'BB1566',
		content: 'On main beam, your lights could dazzle the driver in front. Dip your headlights as soon as the driver passes you and drop back so that the dipped beam falls short of the vehicle in front.'
	},
	{
		questionCode: 'BB1581',
		content: 'Some bus lanes operate only during peak hours and other vehicles may use them outside these hours. Make sure you check the sign for the hours of operation before driving in a bus lane.'
	},
	{
		questionCode: 'BB1622',
		content: 'Your brake lights will give an indication to traffic behind that you\'re slowing down. Good anticipation will allow you time to check your mirrors before slowing.'
	},
	{
		questionCode: 'BB1692',
		content: 'Make sure you carry out the manoeuvre without causing a hazard to other vehicles. Choose a place to turn that\'s safe and considers other road users.'
	},
	{
		questionCode: 'BB1693',
		content: 'When you\'re parking at night, park in a well-lit area. This can help deter criminals from targeting your vehicle.'
	},
	{
		questionCode: 'BB1694',
		content: 'Keep a lookout for traffic signs. If you’re directed to change lanes, do so in good time. Don’t\r\n• push your way into traffic in another lane\r\n• try to gain advantage by delaying changing lanes.'
	},
	{
		questionCode: 'BB1747',
		content: 'Cycle lanes are marked with either a solid or a broken white line. If the line is solid, you should check the times of operation shown on the signs, and not drive or park in the lane during those times. If the line is broken, you shouldn\'t drive or park in the lane unless it\'s unavoidable.'
	},
	{
		questionCode: 'BB1784',
		content: 'Don’t park in a space reserved for disabled people unless you or your passenger are a Blue Badge holder. The badge must be displayed on the dashboard or facia panel, where it can be clearly read through the front windscreen.'
	},
	{
		questionCode: 'BB1794',
		content: 'You must stop your vehicle when signalled to do so by a \r\n• police, DVSA or traffic officer\r\n• traffic warden\r\n• school crossing patrol \r\n• red traffic light. \r\nYou must also stop if you\'re involved in an incident that causes damage or injury to any other person, vehicle, animal or property.'
	},
	{
		questionCode: 'AB2293',
	...
	{
		questionCode: 'BB1235',
		content: 'A continuous white line is used on many roads to indicate the edge of the carriageway. This can be useful when visibility is restricted. The line is discontinued at junctions, lay-bys, and entrances to or exits from private drives.'
	},
	{
		questionCode: 'BB1236',
		content: 'The arrow indicates the direction in which to pass hatch markings or double white lines. If you\'re overtaking, you must return to the left-hand side of the road.'
	},
	{
		questionCode: 'BB1237',
		content: 'There may be occasions when other road users are unable to see your indicator, such as in bright sunlight or at a busy, complicated junction. In these cases, an arm signal will help others to understand your intentions.'
	},
	{
		questionCode: 'BB1239',
		content: 'Other road users may give misleading signals. When you’re waiting at a junction, don’t emerge until you’re sure of their intentions.'
	},
	{
		questionCode: 'BB1240',
		content: 'When there’s queuing traffic ahead and you have to slow down or even stop, briefly showing your hazard warning lights will help alert the traffic behind to the hazard.'
	},
	{
		questionCode: 'BB1582',
		content: 'Leaving your indicators on could confuse other road users and may even lead to a crash. Be aware that if you haven’t turned sharply, your indicators may not self-cancel and you\'ll need to turn them off manually.'
	},
	{
		questionCode: 'BB1583',
		content: 'You need to signal to let other drivers know your intentions. However, if you indicate too early, they may think you\'re turning left into the junction. Correct timing of the signal is very important to avoid misleading others.'
	},
	{
		questionCode: 'AB2436',
	...
	{
		questionCode: 'BB1243',
		content: 'Driving a vehicle without insurance cover is illegal, so be sure that, whoever\'s car you drive, you\'re insured – whether on their policy or on your own. If you need to take out insurance, it\'s worth comparing several quotes before you decide which insurance provider best meets your needs.'
	},
	{
		questionCode: 'BB1245',
		content: 'If your vehicle requires an MOT certificate, it’s illegal to drive it without one and your insurance may be invalid if you do so. The only exceptions are that you may drive to a pre-arranged MOT test appointment, or to a garage for repairs required for the test.'
	},
	{
		questionCode: 'BB1404',
		content: 'It\'s your responsibility to make sure you\'re properly insured for the vehicle you\'re driving. This is the case regardless of whether you\'re a newly qualified driver or one with more experience.'
	},
	{
		questionCode: 'BB1506',
		content: 'Third-party insurance doesn’t cover damage to your own vehicle or injury to yourself. If you have a crash and your vehicle is damaged, you might have to carry out the repairs at your own expense.'
	},
	{
		questionCode: 'BB1533',
		content: 'The registered keeper of the vehicle is responsible for paying the vehicle tax or making a Statutory Off-Road Notification (SORN) if the vehicle is to be kept untaxed and off the road.'
	},
	{
		questionCode: 'BB1537',
		content: 'Every vehicle used on the road has a registration document. This shows the vehicle\'s details, including date of first registration, registration number, registered keeper, previous keeper, make of vehicle, engine size, chassis number, year of manufacture and colour.'
	},
	{
		questionCode: 'BB1538',
		content: 'DVLA needs to keep its records up to date. It sends out a reminder when a vehicle\'s tax is due for renewal. To do this, it needs to know the name and address of the registered keeper. Every vehicle in the country is registered, so it’s possible to trace its history.'
	},
	{
		questionCode: 'BB1539',
		content: 'DVLA holds the records of all vehicles, drivers and riders in Great Britain and Northern Ireland. They need to know if you have a medical condition that might affect your ability to drive safely. You must tell them if your health deteriorates and you become unfit to drive.'
	},
	{
		questionCode: 'BB1599',
		content: 'The cost of insurance varies with your age and how long you\'ve been driving. Usually, the younger you are, the more expensive it is, especially if you\'re under 25.\r\nPass Plus provides additional training to newly qualified drivers. The scheme is recognised by many insurance companies, and taking this extra training could give you reduced insurance premiums, as well as improving your skills and experience.'
	},
	{
		questionCode: 'BB1696',
		content: 'Learner drivers benefit by combining professional driving lessons with private practice. However, you need to be at least 21 years old and have held your driving licence for at least 3 years before you can supervise a learner driver.'
	},
	{
		questionCode: 'BB1697',
		content: 'When a car is three years old (four years old in Northern Ireland), it must pass an MOT test and have a valid MOT certificate before it can be used on the road. Exceptionally, you may \r\n•  drive to a pre-arranged test appointment or to a garage for repairs required for the test\r\n•  drive vehicles that are more than 40 years old without an MOT test, but they must be in a roadworthy condition before being used on the road. See GOV.UK for more details.'
	},
	{
		questionCode: 'BB1698',
		content: 'The vehicle you drive must be roadworthy and in good condition. If it\'s over three years old, it must pass an MOT test to remain in use on the road (unless it\'s exempt from the MOT test – see GOV.UK).'
	},
	{
		questionCode: 'BB1713',
		content: 'Third-party insurance cover is usually cheaper than comprehensive cover. However, it doesn’t cover any damage caused to your own vehicle or property. It only covers damage and injury you cause to others.'
	},
	{
		questionCode: 'BB1714',
		content: 'The minimum insurance required by law is third-party cover. This covers your liability to others involved in a collision but not damage to your vehicle. Basic third-party insurance also won\'t cover theft or fire damage. Ask your insurance company for advice on the best cover for you and make sure that you read the policy carefully.'
	},
	{
		questionCode: 'BB1715',
		content: 'Having an excess on your policy will help to keep the premium down. However, if you make a claim, you\'ll have to pay the excess yourself – in this case, £500.'
	},
	{
		questionCode: 'AB2618',
	...
	{
		questionCode: 'BB1252',
		content: 'Advance warning triangles fold flat and don’t take up much room. Use one to warn other road users if your vehicle has broken down or if there has been an incident. Place it at least 45 metres (147 feet) behind your vehicle (or the incident), on the same side of the road or verge. Place it further back if the scene is hidden by, for example, a bend, hill or dip in the road. Don’t use warning triangles on motorways.'
	},
	{
		questionCode: 'BB1254',
		content: 'If your vehicle breaks down on a level crossing, your first priority is to get everyone out of the vehicle and clear of the crossing. Then use the railway telephone, if there is one, to tell the signal operator. If you have time before the train arrives, move the vehicle clear of the crossing, but only do this if the alarm signals aren\'t activated.'
	},
	{
		questionCode: 'BB1256',
		content: 'A tyre bursting can lead to a loss of control, especially if you’re travelling at high speed. Using the correct procedure should help you to stop the vehicle safely.'
	},
	{
		questionCode: 'BB1259',
		content: 'Pull up on the hard shoulder or in an emergency refuge area and call for assistance. \r\nDon\'t attempt to repair your vehicle while it\'s on the hard shoulder, because of the risk posed by traffic passing at high speeds.'
	},
	{
		questionCode: 'BB1363',
		content: 'If the warning bells ring, leave the vehicle and get any passengers well clear of the crossing immediately.'
	},
	{
		questionCode: 'BB1611',
		content: 'If you\'re wearing sunglasses, you should remove them before driving into a tunnel. If you don’t, your vision will be restricted, even in tunnels that appear to be well lit.'
	},
	{
		questionCode: 'BB1612',
		content: 'Before entering a tunnel, you should switch on your dipped headlights, as this will allow you to see and be seen. In many tunnels, it\'s a legal requirement. \r\nDon’t wear sunglasses while you\'re driving in a tunnel.'
	},
	{
		questionCode: 'BB1623',
		content: 'The fuel in your vehicle can be a dangerous fire hazard. If you smell fuel, check out where it\'s coming from. Never\r\n• use a naked flame near the vehicle if you can smell fuel\r\n• smoke when refuelling your vehicle.'
	},
	{
		questionCode: 'BB1649',
		content: 'If any object falls onto the motorway carriageway from your vehicle, pull onto the hard shoulder near an emergency telephone and call for assistance. Don’t stop on the carriageway or attempt to retrieve anything.'
	},
	{
		questionCode: 'BB1700',
		content: 'Make sure you know what the different warning lights mean. An illuminated warning light could mean that your car is unsafe to drive.  If you aren’t sure about the problem, get a qualified mechanic to check it.'
	},
	{
		questionCode: 'BB1704',
		content: 'A broken-down vehicle in a tunnel can cause serious congestion and danger to other road users. If your vehicle breaks down, get help without delay. Switch on your hazard warning lights, then go to an emergency telephone to call for help.'
	},
	{
		questionCode: 'BB1721',
		content: 'If it’s possible, and you can do so without causing further danger, it may be safer to drive a vehicle that\'s on fire out of a tunnel. The greatest danger in a tunnel fire is smoke and suffocation.'
	},
	{
		questionCode: 'BB1785',
		content: 'First, get yourself and anyone else well away from the crossing. If there’s a railway telephone, use that to get instructions from the signal operator. Then, if there’s time, move the vehicle clear of the crossing.'
	},
	{
		questionCode: 'BB1788',
		content: 'If you\'re in a collision that causes damage or injury to any other person, vehicle, animal or property, by law you must stop. Give your name, the vehicle owner’s name and address, and the vehicle’s registration number to anyone who has reasonable grounds for requesting them.'
	},
	{
		questionCode: 'BB1790',
		content: 'Try to keep calm and don’t rush. Make sure that you\'ve shared all the relevant details with the other driver before you leave the scene. If possible, take pictures and note the positions of all the vehicles involved.'
	},
	{
		questionCode: 'BB1792',
		content: 'If the property owner isn\'t available at the time, you must inform the police about the incident. This should be done as soon as possible, and in any case within 24 hours.'
	},
	{
		questionCode: 'AB2488',
		content: 'The motorway regulations for towing a trailer state that you mustn\'t \r\n•  use the right-hand lane of a three-lane motorway unless directed to do so (for example, at roadworks or due to a lane closure)\r\n•  exceed 60 mph.'
	},
	{
		questionCode: 'BB1271',
		content: 'Strong winds or buffeting from large vehicles can cause a trailer or caravan to swing from side to side (\'snake\'). If this happens, ease off the accelerator. Don’t brake harshly, steer sharply or increase your speed.'
	},
	{
		questionCode: 'BB1364',
		content: 'Check the vehicle handbook. This should give you guidance on the correct tyre pressures for your vehicle and when you may need to adjust them. If you’re carrying a heavy load, you may need to adjust the headlights as well. Most cars have a switch on the dashboard to do this.'
	},
	{
		questionCode: 'BB1365',
	...
	{
		questionCode: 'BB1543',
		content: 'Any load will have an effect on the handling of your vehicle, and this becomes worse as you increase the load. You need to be aware of this when carrying passengers or heavy loads, fitting a roof rack or towing a trailer.'
	},
	{
		questionCode: 'BB1544',
		content: 'Carrying heavy loads will affect control and the vehicle\'s handling characteristics. If the vehicle you\'re driving is overloaded, you\'ll be held responsible.'
	},
	{
		questionCode: 'BB1706',
		content: 'Towing a caravan or trailer affects the way the towing vehicle handles. A stabiliser device isn\'t designed to overcome instability caused by incorrect loading but it can give added security in side winds and from buffeting caused by large vehicles.'
	},
	{
		questionCode: 'BB1707',
		content: 'Riding in a towed caravan is highly dangerous. The safety of the entire unit is dependent on the stability of the trailer. Moving passengers would make the caravan unstable and could cause loss of control.'
	},
	{
		questionCode: 'BB1708',
		content: 'In the event that the trailer becomes detached from the towing vehicle, the breakaway cable activates the trailer brakes before snapping. This allows the towing vehicle to get free of the trailer and out of danger.'
	},
	{
		questionCode: 'BB1735',
		content: 'You must know how to load your trailer or caravan so that the hitch exerts an appropriate downward force on the tow ball. Information about the maximum permitted noseweight can be found in your vehicle handbook or obtained from your vehicle manufacturer’s agent.'
	},
	{
		questionCode: 'BB1745',
		content: 'Any load must be securely fastened to the vehicle. The safest way to carry items on the roof is in a specially designed roof box. This will help to keep your luggage secure and dry, and it also has less wind resistance than loads carried exposed on a roof rack.'
	},
	{
		questionCode: 'BB1754',
	...
	{
		questionCode: 'AB2950',
		content: 'To rejoin the carriageway from an emergency refuge area, you must use the emergency telephone and follow the operator\'s advice. A lane may have to be closed so that you can rejoin the carriageway safely.'
	},
	{
		questionCode: 'AB2951',
